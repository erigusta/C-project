...
void initDistance(){
  ...
  if(!sensor_is_plugged((LEGO_EV3_US), SENSOR_TYPE__NONE_)) {
		printf("Stoppa in US i en port ex port 3 \n");// ersett sensor_us med  lego_ev3_us
...
// gör en func för init asvtåndssensorn
// gör en funtkion för att köra tills inom 30 cm? (beror på amins move )
// anmäl inför ingenjörsintervju
// ma in 1
// inf handlending 1
